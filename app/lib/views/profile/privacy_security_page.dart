        ...
        return StatefulBuilder(
          builder: (context, setState) {
            Future<void> _changePassword() async {
              ...
              try {
                // On ne vérifie pas le mot de passe actuel (version statique)
                // On passe directement à la modification du mot de passe
                await authController.resetPassword(_newPasswordController.text);
            ...
            return Obx(() {
              return AlertDialog(
                ...
                actions: [
                  ...
                  ElevatedButton(
                    onPressed: authController.isLoading.value ? null : _changePassword,
